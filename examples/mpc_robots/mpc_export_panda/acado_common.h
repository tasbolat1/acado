...
/** Matrix of size: 140 x 14 (row major format) */
real_t evGx[ 1960 ];
...
/** Matrix of size: 140 x 21 (row major format) */
real_t Q2[ 2940 ];
...
/** Matrix of size: 770 x 7 (row major format) */
real_t E[ 5390 ];
...
/** Matrix of size: 140 x 70 (row major format) */
real_t A[ 9800 ];
